  ...
  return (
    <Container>
      <form className={classNames(styles.giftForm)} onSubmit={submitForm}>
        <Row lgReverse>
          <Col xs={12} lg={6}>
            <h3 className={classNames("text--h-lg")}>Luna di Miele</h3>
            <p className={classNames("text--p-md")}>
              Se lo desiderate, potete contribuire a realizzare il nostro primo
              viaggio da marito e moglie.
            </p>
            <br />
            <p className={classNames("text--strong")}>Coordinate Bancarie:</p>
            <p>
        ...
        <Row>
          <Col xs={12}>
            <p className={classNames("text--strong")}>Il tuo regalo</p>
          </Col>
          <Col xs={12}>
            <div className={classNames(styles.giftContainer)}>
              ...
              <div className={classNames(styles.buttonContainer)}>
                <Button
                  ...
                  onClick={() => setGiftValue((currValue) => currValue + 10)}
                >
                  +10
                </Button>
                <Button
                  ...
                  onClick={() => setGiftValue((currValue) => currValue + 50)}
                >
                  +50
                </Button>
                <Button
                  ...
                  onClick={() => setGiftValue((currValue) => currValue + 100)}
                >
                  +100
                </Button>
              </div>
        ...
        <Row>
          <Col xs={12}>
            <p className={classNames("text--strong")}>Regalato da</p>
          </Col>
          <Col xs={12}>
            <TextField
              fullWidth
        ...
        <Row>
          <Col xs={12}>
            <p className={classNames("text--strong")}>Lasciaci un messaggio</p>
          </Col>
          <Col xs={12}>
            <TextField
              label="Messaggio"
