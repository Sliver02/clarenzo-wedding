    ...
    <Container>
      ...
      >
        <Row>
          <Col xs={12}>
            ...
            <p className={classNames("text--p-md")}>
              Fateci sapere se parteciperete alla nostra giornata, in quanti
              sarete e tutto ciò che può esserci utile per accogliervi al
              meglio.
            </p>
          </Col>
        </Row>
            ...
            <div>
              ...
              <div>
                <FormControlLabel
                  control={
                    <Checkbox
                      onChange={() => handlePartecipating(ResponseEnum.YES)}
                      checked={isPartecipating == ResponseEnum.YES}
                    />
                  }
                  label="Si"
                />
                <FormControlLabel
                  control={
                    <Checkbox
                      onChange={() => handlePartecipating(ResponseEnum.NO)}
                      checked={isPartecipating == ResponseEnum.NO}
                    />
                  }
                  label="No"
                />
              ...
              <Col xs={12}>
                ...
                <div style={{ marginTop: "0.5rem" }}>
                  <FormControlLabel
                    control={
                      <Checkbox
                        onChange={() => handlePlusOne(ResponseEnum.YES)}
                        checked={plusOne == ResponseEnum.YES}
                      />
                    }
                    label="Si"
                  />
                  <FormControlLabel
                    control={
                      <Checkbox
                        onChange={() => handlePlusOne(ResponseEnum.NO)}
        ...
        {isPartecipating == ResponseEnum.YES && (
          <Row>
            <Col xs={12}>
              ...
              <p className={classNames("text--p-md")}>
                Se hai bisogno di una stanza dove passare la notte dopo la
                festa, la struttura di riferimento è questa:
              </p>
              <p className={classNames("text--p-md")}>
                <strong>
                  <Link href="https://www.villamaternini.com/" target="_blank">
                    Hotel Villa Maternini
                  </Link>
                </strong>
                <br />
                Via Pier Antonio Mutti, 7, 31028 Vazzola TV <br />
                tel. 0438 442096 <br />
              </p>
              <p className={classNames("text--p-sm")}>
                Questa struttura offre diverse opzioni fra cui camere singole,
                matrimoniali, suite da 4/5/6 persone (con colazione inclusa),
                quindi avrete la possibilità di organizzarvi a seconda delle
                vostre esigenze. Qualora doveste prenotare, ricordatevi di
                avvisare che siete ospiti del nostro matrimonio, così verrete
                accomodati nello stesso edificio.
              </p>
            </Col>
          </Row>
        )}
        <Row>
          <Col xs={12}>
            <p className={classNames("text--strong")}>
              Mettici al corrente di qualsiasi altra esigenza o dubbio!
            </p>
          </Col>
          <Col xs={12}>
            <TextField
